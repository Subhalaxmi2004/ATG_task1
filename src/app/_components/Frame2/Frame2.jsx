...
const Frame2 = () => {
    return (
        <main className='w-full bg-white flex justify-center items-center p-4'>
            <div className='grid justify-center items-center lg:grid-cols-2 grid-cols-1 gap-8 rounded-[8px]'>
                <div className='w-[312px] h-[216px] text-[12px] lg:w-[490px] lg:h-[297px] xl:w-[608px] border border-gray-400 p-4 lg:p-8 flex flex-col items-center lg:items-start justify-center rounded-[8px] gap-6'>
                    <div className='flex flex-row justify-center items-center gap-2'>
                        ...
                        <span className='text-[24px] font-semibold'>People</span>
                    </div>
                    <p className='text-[12px] lg:text-[18px]'>
                        Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.
                    </p>
                    <button className='connect-button w-[264px] h-[32px] text-[14px] lg:text-[16px] font-semibold lg:w-[142px] lg:h-[40px]'>
                        Connect
                    </button>
                </div>
                <div className='w-[312px] h-[216px] text-[12px] lg:w-[490px] lg:h-[297px] xl:w-[608px] border border-gray-400 p-4 lg:p-8 flex flex-col items-center lg:items-start justify-center rounded-[8px] gap-6'>
                    <div className='flex flex-row justify-center items-center gap-2'>
                        ...
                        <span className='text-[24px] font-semibold'>Place</span>
                    </div>
                    <p className='text-[12px] lg:text-[18px]'>
                ...
                <div className='w-[312px] h-[216px] text-[12px] lg:w-[490px] lg:h-[297px] xl:w-[608px] border border-gray-400 p-4 lg:p-8 flex flex-col items-center lg:items-start justify-center rounded-[8px] gap-6'>
                    <div className='flex flex-row justify-center items-center gap-2 mb-1.5'>
                        ...
                        <span className='text-[24px] font-semibold'>Program</span>
                    </div>
                    <p className='text-[12px] lg:text-[18px] my-3'>
